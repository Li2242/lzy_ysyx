...
0x0040a503,   // lw    x10, 4(x1)        # x10 = mem[0x80000004]，应为0x123

0x8fff00b7,   // lui   x1, 0x8fff0       # x1 = 0x8fff0000，高地址区域
0x00008093,   // addi  x1, x1, 0         # 保持 x1 不变

0x45600313,   // addi  x6, x0, 0x456     # x6 = 0x456
0x78900413,   // addi  s0, x0, 0x789     # s0 = 0x789

0x0020a023,   // sw    x2, 0(x1)         # mem[0x8fff0000] = 1 (测试重用x2)
0x0040a423,   // sw    x4, 4(x1)         # mem[0x8fff0004] = 0x123 (测试重用x4)

0x0000a283,   // lw    x5, 0(x1)         # x5 = mem[0x8fff0000]，应为1
0x0040a503,   // lw    x10, 4(x1)        # x10 = mem[0x8fff0004]，应为0x123

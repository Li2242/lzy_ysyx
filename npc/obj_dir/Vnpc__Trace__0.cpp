...
void Vnpc___024root__trace_chg_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgCData(oldp+8,((0x1fU & (vlSelfRef.npc__DOT__inst 
                                         >> 7U))),5);
        bufp->chgCData(oldp+9,((((((IData)(vlSelfRef.npc__DOT__mem_ren) 
                                   << 6U) | ((IData)(
                                                     (0x33U 
                                                      == 
                                                      (0x707fU 
        ...
        bufp->chgBit(oldp+10,(vlSelfRef.npc__DOT__mem_ren));
        ...
        bufp->chgIData(oldp+28,(((IData)(vlSelfRef.npc__DOT__mem_ren)
                                  ...
                                  : 0U)),32);
        bufp->chgIData(oldp+29,(((- (IData)((IData)(vlSelfRef.npc__DOT__mem_ren))) 

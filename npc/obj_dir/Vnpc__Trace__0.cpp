...
void Vnpc___024root__trace_chg_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgCData(oldp+8,((0x1fU & (vlSelfRef.npc__DOT__inst 
                                         >> 7U))),5);
        bufp->chgCData(oldp+9,((((((IData)(vlSelfRef.npc__DOT__is_lw) 
                                   << 6U) | ((IData)(
                                                     (0x33U 
                                                      == 
                                                      (0x707fU 
        ...
        bufp->chgIData(oldp+14,(vlSelfRef.npc__DOT__imm_I),32);
        ...
        bufp->chgBit(oldp+20,(((IData)(vlSelfRef.npc__DOT____VdfgRegularize_h9a2a8a06_0_7) 
                               & (0x13U == (0x7fU & vlSelfRef.npc__DOT__inst)))));
        bufp->chgBit(oldp+21,((IData)((0x33U == (0x707fU 
                                                 & vlSelfRef.npc__DOT__inst)))));
        bufp->chgBit(oldp+22,(vlSelfRef.npc__DOT__is_lw));
                                    ...
                                    | (((1U == (7U 
                                        ...
                                        << 1U) | (0U 
                                                  ...
                                                  (7U 
                                                   & (vlSelfRef.npc__DOT__inst 
                                                      >> 0xcU))))))),8);
        bufp->chgIData(oldp+28,(((IData)(vlSelfRef.npc__DOT__mem_ren)
                                  ? vlSelfRef.npc__DOT____VdfgExtracted_h414fb206__0
                                  : 0U)),32);
        bufp->chgIData(oldp+29,(((- (IData)((IData)(vlSelfRef.npc__DOT__is_lw))) 

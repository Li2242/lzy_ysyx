...
void Vnpc___024root__trace_chg_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgIData(oldp+0,(((- (IData)((IData)(vlSelfRef.npc__DOT__mem_en))) 
        ...
        bufp->chgIData(oldp+3,(vlSelfRef.npc__DOT__imm),32);
        bufp->chgCData(oldp+4,((7U & (vlSelfRef.npc__DOT__inst 
                                      >> 0xcU))),3);
        bufp->chgIData(oldp+5,(vlSelfRef.npc__DOT__src1),32);
        bufp->chgIData(oldp+6,(((0U == (0x1fU & (vlSelfRef.npc__DOT__inst 
                                                 >> 0x14U)))
        ...
        bufp->chgCData(oldp+9,((0x1fU & (vlSelfRef.npc__DOT__inst 
                                         >> 7U))),5);
        bufp->chgCData(oldp+10,((((((IData)(vlSelfRef.npc__DOT__mem_en) 
        ...
        bufp->chgBit(oldp+11,(((IData)(vlSelfRef.npc__DOT__is_auipc) 

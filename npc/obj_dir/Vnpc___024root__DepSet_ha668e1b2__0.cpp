...
void Vnpc___024root___eval_triggers__act(Vnpc___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.__VactTriggered.setBit(0U, ((IData)(vlSelfRef.npc__DOT__mem_en) 
                                          != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__npc__DOT__mem_en__1)));
...
VL_INLINE_OPT void Vnpc___024root___act_sequent__TOP__0(Vnpc___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelfRef.npc__DOT__mem_en))) {
        VL_WRITEF_NX("mem_en=%b, is_lbu=%b, raddr=0x%08x\n",0,
                     1,vlSelfRef.npc__DOT__mem_en,1,
                     (IData)(vlSelfRef.npc__DOT__is_lbu),
                     32,vlSelfRef.npc__DOT__raddr);

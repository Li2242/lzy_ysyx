...
VL_ATTR_COLD void Vnpc___024root__trace_init_sub__TOP__0(Vnpc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+11,0,"mem_ren",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
...
VL_ATTR_COLD void Vnpc___024root__trace_full_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+9,((0x1fU & (vlSelfRef.npc__DOT__inst 
                                      >> 7U))),5);
    bufp->fullCData(oldp+10,((((((IData)(vlSelfRef.npc__DOT__mem_ren) 
                                 << 6U) | ((IData)(
                                                   (0x33U 
                                                    == 
                                                    (0x707fU 
    ...
    bufp->fullBit(oldp+11,(vlSelfRef.npc__DOT__mem_ren));
    ...
    bufp->fullIData(oldp+29,(((IData)(vlSelfRef.npc__DOT__mem_ren)
                               ...
                               : 0U)),32);
    bufp->fullIData(oldp+30,(((- (IData)((IData)(vlSelfRef.npc__DOT__mem_ren))) 

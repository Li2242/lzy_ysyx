...
VL_ATTR_COLD void Vnpc___024root__trace_init_sub__TOP__0(Vnpc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+70,0,"alu_result",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+71,0,"pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+72,0,"src1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+81,0,"src2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+73,0,"imm",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+75,0,"reg_wen",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+67,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+68,0,"rst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+76,0,"din",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+73,0,"imm",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+72,0,"src1",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+81,0,"src2",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+84,0,"wen",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+69,0,"inst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+72,0,"src1",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+81,0,"src2",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+74,0,"rd",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declBus(c+73,0,"imm",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+75,0,"reg_wen",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+77,0,"r1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    ...
    tracep->declBus(c+77,0,"raddr1",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declBus(c+72,0,"rdata1",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+81,0,"rdata2",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+77,0,"raddr1",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declBus(c+72,0,"rdata1",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+80,0,"raddr2",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 4,0);
    tracep->declBus(c+81,0,"rdata2",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->pushPrefix("rf", VerilatedTracePrefixType::ARRAY_UNPACKED);
    for (int i = 0; i < 32; ++i) {
...
VL_ATTR_COLD void Vnpc___024root__trace_full_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+35,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[0]),32);
    bufp->fullIData(oldp+36,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[1]),32);
    bufp->fullIData(oldp+37,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[2]),32);
    bufp->fullIData(oldp+38,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[3]),32);
    bufp->fullIData(oldp+39,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[4]),32);
    bufp->fullIData(oldp+40,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[5]),32);
    bufp->fullIData(oldp+41,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[6]),32);
    bufp->fullIData(oldp+42,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[7]),32);
    bufp->fullIData(oldp+43,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[8]),32);
    bufp->fullIData(oldp+44,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[9]),32);
    bufp->fullIData(oldp+45,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[10]),32);
    bufp->fullIData(oldp+46,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[11]),32);
    bufp->fullIData(oldp+47,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[12]),32);
    bufp->fullIData(oldp+48,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[13]),32);
    bufp->fullIData(oldp+49,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[14]),32);
    bufp->fullIData(oldp+50,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[15]),32);
    bufp->fullIData(oldp+51,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[16]),32);
    bufp->fullIData(oldp+52,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[17]),32);
    bufp->fullIData(oldp+53,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[18]),32);
    bufp->fullIData(oldp+54,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[19]),32);
    bufp->fullIData(oldp+55,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[20]),32);
    bufp->fullIData(oldp+56,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[21]),32);
    bufp->fullIData(oldp+57,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[22]),32);
    bufp->fullIData(oldp+58,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[23]),32);
    bufp->fullIData(oldp+59,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[24]),32);
    bufp->fullIData(oldp+60,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[25]),32);
    bufp->fullIData(oldp+61,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[26]),32);
    bufp->fullIData(oldp+62,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[27]),32);
    bufp->fullIData(oldp+63,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[28]),32);
    bufp->fullIData(oldp+64,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[29]),32);
    bufp->fullIData(oldp+65,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[30]),32);
    bufp->fullIData(oldp+66,(vlSelfRef.npc__DOT__u_regfile__DOT__rf[31]),32);
    bufp->fullBit(oldp+67,(vlSelfRef.clk));
    bufp->fullBit(oldp+68,(vlSelfRef.rst));
    bufp->fullIData(oldp+69,(vlSelfRef.inst),32);
    bufp->fullIData(oldp+70,(vlSelfRef.alu_result),32);
    bufp->fullIData(oldp+71,(vlSelfRef.pc),32);
    bufp->fullIData(oldp+72,(((0U == (0x1fU & (vlSelfRef.inst 
                                               >> 0xfU)))
                               ? 0U : vlSelfRef.npc__DOT__u_decoder__DOT__u_RegisterFile1__DOT__rf
                              [(0x1fU & (vlSelfRef.inst 
                                         >> 0xfU))])),32);
    bufp->fullIData(oldp+73,((((- (IData)((vlSelfRef.inst 
                                           >> 0x1fU))) 
                               << 0xcU) | (vlSelfRef.inst 
                                           >> 0x14U))),32);
    bufp->fullCData(oldp+74,((0x1fU & (vlSelfRef.inst 
                                       >> 7U))),5);
    bufp->fullBit(oldp+75,((IData)((0x13U == (0x707fU 
                                              & vlSelfRef.inst)))));
    bufp->fullIData(oldp+76,(((IData)(4U) + vlSelfRef.pc)),32);
    bufp->fullCData(oldp+77,((0x1fU & (vlSelfRef.inst 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+78,((0x7fU & vlSelfRef.inst)),7);
    bufp->fullCData(oldp+79,((7U & (vlSelfRef.inst 
                                    >> 0xcU))),3);
    bufp->fullCData(oldp+80,((0x1fU & (vlSelfRef.inst 
                                       >> 0x14U))),5);
}

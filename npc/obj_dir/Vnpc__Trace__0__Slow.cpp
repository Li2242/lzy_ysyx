...
VL_ATTR_COLD void Vnpc___024root__trace_init_sub__TOP__0(Vnpc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,0,"inst",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+6,0,"funct3",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+7,0,"src1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+8,0,"src2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+12,0,"alu_op",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    tracep->declBit(c+72,0,"reg_wen",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+5,0,"imm",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+7,0,"src1",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+8,0,"src2",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+12,0,"alu_op",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    tracep->declBus(c+1,0,"rdata",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+5,0,"result_lui",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+1,0,"result_lw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
    tracep->pushPrefix("u_decoder3_8", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+6,0,"in",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    ...
    tracep->declBus(c+4,0,"in",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
...
VL_ATTR_COLD void Vnpc___024root__trace_full_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+4,((0x7fU & vlSelfRef.npc__DOT__inst)),7);
    bufp->fullIData(oldp+5,(vlSelfRef.npc__DOT__imm),32);
    bufp->fullCData(oldp+6,((7U & (vlSelfRef.npc__DOT__inst 
                                   >> 0xcU))),3);
    bufp->fullIData(oldp+7,(vlSelfRef.npc__DOT__src1),32);
    bufp->fullIData(oldp+8,(((0U == (0x1fU & (vlSelfRef.npc__DOT__inst 
                                              >> 0x14U)))
    ...
    bufp->fullIData(oldp+20,(((((- (IData)((vlSelfRef.npc__DOT__inst 
                              ...
                              | (((0xff000U & vlSelfRef.npc__DOT__inst) 
                                 ...
                                 | (0x7feU & (vlSelfRef.npc__DOT__inst 
                                              >> 0x14U))))),32);
    bufp->fullBit(oldp+21,(((IData)(vlSelfRef.npc__DOT__is_U) 
                            & (0x17U == (0x7fU & vlSelfRef.npc__DOT__inst)))));
    bufp->fullBit(oldp+22,(((IData)(vlSelfRef.npc__DOT__is_U) 
                            & (0x37U == (0x7fU & vlSelfRef.npc__DOT__inst)))));
    bufp->fullBit(oldp+23,(vlSelfRef.npc__DOT__is_jalr));
    bufp->fullBit(oldp+24,(((IData)(vlSelfRef.npc__DOT____VdfgRegularize_h9a2a8a06_0_7) 
                            & (0x13U == (0x7fU & vlSelfRef.npc__DOT__inst)))));
    bufp->fullBit(oldp+25,((IData)((0x33U == (0x707fU 
                                              & vlSelfRef.npc__DOT__inst)))));

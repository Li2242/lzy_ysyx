...
VL_ATTR_COLD void Vnpc___024root__trace_init_sub__TOP__0(Vnpc___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+73,0,"mem_ren",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+74,0,"mem_wen",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+30,0,"raddr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->pushPrefix("pc_4", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+76,0,"WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+77,0,"RESET_VAL",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+66,0,"clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+67,0,"rst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+29,0,"result_lw",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
...
VL_ATTR_COLD void Vnpc___024root__trace_const_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+73,(vlSelfRef.npc__DOT__mem_ren));
    bufp->fullBit(oldp+74,(vlSelfRef.npc__DOT__mem_wen));
    bufp->fullIData(oldp+75,(vlSelfRef.npc__DOT__imm_R),32);
    bufp->fullIData(oldp+76,(0x20U),32);
    bufp->fullIData(oldp+77,(0x80000000U),32);
...
VL_ATTR_COLD void Vnpc___024root__trace_full_0_sub_0(Vnpc___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+9,((0x1fU & (vlSelfRef.npc__DOT__inst 
                                      >> 7U))),5);
    bufp->fullCData(oldp+10,((((((IData)(vlSelfRef.npc__DOT__is_lw) 
                                 << 6U) | ((IData)(
                                                   (0x33U 
                                                    == 
                                                    (0x707fU 
    ...
    bufp->fullIData(oldp+15,(vlSelfRef.npc__DOT__imm_I),32);
    ...
    bufp->fullBit(oldp+21,(((IData)(vlSelfRef.npc__DOT____VdfgRegularize_h9a2a8a06_0_7) 
                            & (0x13U == (0x7fU & vlSelfRef.npc__DOT__inst)))));
    bufp->fullBit(oldp+22,((IData)((0x33U == (0x707fU 
                                              & vlSelfRef.npc__DOT__inst)))));
    bufp->fullBit(oldp+23,(vlSelfRef.npc__DOT__is_lw));
                                 ...
                                 | (((1U == (7U & (vlSelfRef.npc__DOT__inst 
                                     ...
                                     << 1U) | (0U == 
                                               (7U 
                                                & (vlSelfRef.npc__DOT__inst 
                                                   >> 0xcU))))))),8);
    bufp->fullIData(oldp+29,(((IData)(vlSelfRef.npc__DOT__mem_ren)
                               ? vlSelfRef.npc__DOT____VdfgExtracted_h414fb206__0
                               : 0U)),32);
    bufp->fullIData(oldp+30,(((- (IData)((IData)(vlSelfRef.npc__DOT__is_lw))) 
